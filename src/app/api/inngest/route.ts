...
import { updatePastEvents } from '@/services/inngest/crons/update-past-events';
...
export const { GET, POST, PUT } = serve({
  ...
  functions: [
    ...
    stripeUserBookedEvent,
    updatePastEvents, // Cron: runs every 2 minutes to close past events
  ],
});
